            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="tabel-guru.php" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Data Guru</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Form Tambah Guru </h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Form Tambah Guru</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="../../proses/edit_guru.php" method="post" id="basicform" data-parsley-validate="">
                                        <div class="form-group">
                                            <label for="inputNIP">NIP</label>
                                            <input id="inputNIP" value="<?php echo $data_guru['NIP']; ?>" type="text" name="NIP" data-parsley-trigger="change" required="" placeholder="Masukan NIP" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputNama">Nama Guru</label>
                                            <input id="inputNama" value="<?php echo $data_guru['Nama']; ?>" type="text" name="nama_guru" data-parsley-trigger="change" required="" placeholder="Masukan Nama Guru" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputMapel">Mata Pelajaran</label>
                                            <input id="inputMapel" value="<?php echo $data_guru['Mapel']; ?>" type="text" name="mapel" placeholder="Mata Pelajaran" required="" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputKelas">Kelas</label>
                                            <input id="inputKelas" value="<?php echo $data_guru['Kelas']; ?>" type="text" name="kelas" required="" placeholder="Kelas" class="form-control">
                                        </div>
                                        <div class="row">
