        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Data Guru SMA Negeri 1 Malang <a href="form-guru.php" class="btn btn-rounded btn-light" style="margin-left:60%;">Tambah Guru</a></h5>
                                    ...
                                    <table class="table">
                                        <thead class="bg-light">
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0" colspan="2">Aksi</th>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                    <a href="form-edit-guru.php?id=<?php echo $row['NIP']; ?>" class="btn btn-rounded btn-info">Edit</a>
                                                    <a href="../../proses/hapus_guru.php?id=<?php echo $row['NIP']; ?>" class="btn btn-rounded btn-danger">Hapus</a>
                                                    </center>
                                                </td>
                                            </tr>
