        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Tabel Rangking</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Data Kinerja Guru SMA Negeri 1 Malang</h5>
                                    ...
                                    <table class="table">
                                        <thead class="bg-light">
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0">Hasil penilaian</th>
                                        ...
                                        <?php
                                        $sql_rangking = "SELECT * FROM rangking";
                                        $data_rangking = $conn->query($sql_rangking);
                                        $nomer = 0;
                                        
                                        while($row=$data_rangking->fetch_array()){
                                            $NIP = $row['NIP'];
                                            $sql_guru      = mysqli_query($conn,"SELECT * from data_guru where NIP ='$NIP'");
