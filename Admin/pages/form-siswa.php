                    ...
                    <li class="nav-item dropdown nav-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                            <div class="nav-user-info">
                                <h5 class="mb-0 text-white nav-user-name">Nama Siswa</h5>
                                <span class="status"></span><span class="ml-2">NIS</span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="../../proses/tambah_siswa.php" method="post" id="basicform" data-parsley-validate="">
                                        <div class="form-group">
                                            <label for="inputNIS">NIS</label>
                                            <input id="inputNIS" type="text" name="NIS" data-parsley-trigger="change" required="" placeholder="Masukan NIS" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputNama">Nama Siswa</label>
                                            <input id="inputNama" type="text" name="nama_siswa" data-parsley-trigger="change" required="" placeholder="Masukan Nama Siswa" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputKelas">Kelas</label>
                                            <input id="inputKelas" type="text" name="kelas" placeholder="Kelas" required="" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputJurusan">Jurusan</label>
                                            <input id="inputJurusan" type="text" name="jurusan" placeholder="Jurusan" required="" class="form-control">
                                        </div>
                                        <div class="form-group">
