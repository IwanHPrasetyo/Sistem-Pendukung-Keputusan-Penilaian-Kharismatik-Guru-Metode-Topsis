        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">    
                        <h5 class="card-header">Data Siswa SMA Negeri 1 Malang <a href="form-siswa.php" class="btn btn-rounded btn-light" style="margin-left:60%;">Tambah Siswa</a> </h5>
                                    ...
                                    <table class="table">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                    <a href="form-edit-siswa.php?id=<?php echo $row['NIS']; ?>" class="btn btn-rounded btn-info">Edit</a>
                                                    <a href="../../proses/hapus_siswa.php?id=<?php echo $row['NIS']; ?>" class="btn btn-rounded btn-danger">Hapus</a>
                                                    </center>
                                                </td>
                                            </tr>
